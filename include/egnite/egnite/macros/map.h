...
#define EGNITE_MAP_NEXT(test, next) EGNITE_MAP_NEXT1(EGNITE_MAP_GET_END test, next)

#define EGNITE_MAP0(f, x, peek, ...) f(x) EGNITE_MAP_NEXT(peek, EGNITE_MAP1)(f, peek, __VA_ARGS__)
#define EGNITE_MAP1(f, x, peek, ...) f(x) EGNITE_MAP_NEXT(peek, EGNITE_MAP0)(f, peek, __VA_ARGS__)

#define EGNITE_MAP_LIST_NEXT1(test, next) EGNITE_MAP_NEXT0(test, EGNITE_MAP_COMMA next, 0)
#define EGNITE_MAP_LIST_NEXT(test, next) EGNITE_MAP_LIST_NEXT1(EGNITE_MAP_GET_END test, next)
...
#define EGNITE_MAP(f, ...) EGNITE_EVAL(EGNITE_MAP1(f, __VA_ARGS__, ()()(), ()()(), ()()(), 0))
