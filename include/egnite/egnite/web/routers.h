#ifndef EGNITE_WEB_ROUTERS_H
#define EGNITE_WEB_ROUTERS_H
...
#define EGNITE_ROUTING_PROPERTY_NOTIFY(path) Q_SIGNAL void path##Changed(const QUrl &value);
...
public:                                                                                            \
  Q_PROPERTY(name *routing READ getRouting WRITE setRouting NOTIFY routingChanged)                 \
...
EGNITE_REGISTER_ROUTING(SimpleJWTAuthenticatorRouting, tokenCreate, tokenRefresh, tokenBlacklist)

} // namespace egnite::web

#endif // EGNITE_WEB_ROUTERS_H
