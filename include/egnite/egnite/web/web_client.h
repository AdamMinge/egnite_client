...
namespace egnite::web
{
  ...
  public:
    ...
    Q_PROPERTY(
      WebAuthenticator* authenticator READ getAuthenticator WRITE setAuthenticator NOTIFY authenticatorChanged)
    Q_PROPERTY(
      WebAuthorizator* authorizator READ getAuthorizator WRITE setAuthorizator NOTIFY authorizatorChanged)
  ...
  Q_SIGNALS:
    ...
    void authenticatorChanged(WebAuthenticator* authenticator);
    void authorizatorChanged(WebAuthorizator* authorizator);
