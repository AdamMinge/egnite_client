...
class WrappedReplyDecoratorPrivate : public QObjectPrivate {
 public:
  Q_DECLARE_PUBLIC(WrappedReplyDecorator)

 public:
  explicit WrappedReplyDecoratorPrivate(IReplyDecorator* reply_decorator);
 ...
 private:
  IReplyDecorator* m_reply_decorator;
};
